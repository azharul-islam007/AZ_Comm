...
def get_semantic_embedding(sentence, max_length=512):
    """
    ...
    # Return mean of chunk embeddings
    if embeddings:
        return np.mean(embeddings, axis=0)
    else:
        return np.zeros(768)  # Fallback for empty input
...
def load_or_train_vae_compressor(compression_factor=VAE_COMPRESSION_FACTOR):
    """
