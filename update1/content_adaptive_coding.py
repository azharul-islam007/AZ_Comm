...
class ContentAdaptivePhysicalChannel(PhysicalChannelLayer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.enable_content_adaptive_coding = kwargs.get('enable_content_adaptive_coding', True)
        self.content_classifier = None
        self.content_classifier_path = kwargs.get('content_classifier_path', './models/content_classifier.pth')
