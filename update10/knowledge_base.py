...
class SemanticKnowledgeBase:
    ...
    def _initialize_europarl_kb(self):
        """Initialize with enhanced Europarl-specific knowledge"""
        logger.info("Initializing Europarl knowledge base")

        # Enhanced Parliamentary terminology corrections
        self.term_dict = {
            ...
            # NEW: Additional terms for better coverage
            "Coupcil": "Council",
            "Councep": "Council",
            "Concil": "Council",
            "Directave": "Directive",
            ...
            "lhav": "that",
            "pleoses": "pleased",
            "inndmiysibility": "inadmissibility",
            "deodte": "debate",
            "wequestej": "requested",
            "haxe": "have",
            "kreseot": "present",
    ...
    def kb_guided_reconstruction(self, noisy_text):
        """Reconstruct text using knowledge base guidance with advanced correction strategies"""
        # Stage 1: Check for common error patterns first (fast path)
        ...
        # Stage 2: Dictionary lookup (efficient for exact matches)
        words = noisy_text.split()
        corrected_words = []
        changes_made = False
        ...
        # Stage 3: Apply phrase-level corrections for better coherence
        # This improves detection of multi-word expressions that were corrupted
