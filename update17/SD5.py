...
def validate_reconstruction(original, reconstructed, kb_reconstructed=None):
    ...
    # Step 4: Final comparison with original - if reconstruction quality is poor,
    # prefer the original or KB reconstruction
    ...
    if orig_similarity < 0.3:  # Very different from original
