...
class EnhancedEvaluationFramework:
    ...
    def safe_evaluate_reconstruction(self, original_texts, reconstructed_texts):
        """
        Safe version of evaluate_reconstruction that avoids dictionary modification during iteration.
        ...
        # Create dictionary structure safely to avoid modification during iteration
        results = {
            "standard_metrics": {},
            "semantic_metrics": {},
            "domain_metrics": {},
        ...
        # Calculate standard metrics - using a separate function and copying results
        standard_metrics = self._calculate_standard_metrics(original_texts, reconstructed_texts)
        results["standard_metrics"] = dict(standard_metrics)  # Make a copy

        # Calculate semantic metrics - same approach
        semantic_metrics = self._calculate_semantic_metrics(original_texts, reconstructed_texts)
        results["semantic_metrics"] = dict(semantic_metrics)  # Make a copy

        # Calculate domain-specific metrics
        domain_metrics = self._calculate_domain_metrics(original_texts, reconstructed_texts)
        results["domain_metrics"] = dict(domain_metrics)  # Make a copy

        # Calculate information-theoretic metrics
        info_metrics = self._calculate_information_metrics(original_texts, reconstructed_texts)
        results["information_metrics"] = dict(info_metrics)  # Make a copy

        # Calculate overall scores after all other calculations are complete
        results["overall"] = self._calculate_overall_scores(dict(results))  # Pass a copy of results
