...
class SemanticKnowledgeBase:
    ...
    def _initialize_europarl_kb(self):
        ...
        # Keep your existing term_dict and add these additional terms
        additional_terms = {
            # Parliamentary procedures
            "recmmend": "recommend",
            "recmmendation": "recommendation",
            "ammendment": "amendment",
            "legslation": "legislation",
            "prposal": "proposal",
            "implemntation": "implementation",
            "delegtion": "delegation",
            ...
            "qeustion": "question",
            "tme": "time",
            "suplmentary": "supplementary",
            "budgt": "budget",
            "adminstration": "administration",
            "juristiction": "jurisdiction",
            "instittion": "institution",
            "priciple": "principle",
        ...
        additional_context_rules = {
            "report": {
                "context_words": ["committee", "draft", "adopted", "presentation", "final"],
                "candidates": ["Report", "report"]
            },
            "amendment": {
                "context_words": ["table", "vote", "adopt", "reject", "compromise"],
                "candidates": ["Amendment", "amendment", "amendments"]
            },
            "proposal": {
                "context_words": ["commission", "legislative", "adopt", "reject", "approve"],
                "candidates": ["Proposal", "proposal"]
            },
            "directive": {
                "context_words": ["implement", "transpose", "member", "states", "deadline"],
                "candidates": ["Directive", "directive"]
            },
            "budget": {
                "context_words": ["annual", "funds", "allocation", "financial", "expenditure"],
