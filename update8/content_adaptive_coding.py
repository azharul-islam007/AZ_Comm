...
class ContentAdaptivePhysicalChannel(PhysicalChannelLayer):
    ...
    def _load_content_classifier(self):
        try:
            ...
            # Create model with correct dimensions regardless of load success
            ...
            if os.path.exists(self.content_classifier_path):
                ...
                # Add robust checkpoint validation
                if isinstance(checkpoint, dict) and 'model_state_dict' in checkpoint:
                    ...
                    # Handle malformed checkpoint
                    logger.warning("Invalid classifier checkpoint format - initializing with fallback")
                    self._initialize_fallback_classifier(embedding_dim)
            else:
