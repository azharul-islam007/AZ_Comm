...
class AdvancedRLAgent(nn.Module):
    ...
    def select_action(self, state, budget_remaining, force_basic=False, corruption_level=None):
        ...
        # NEW: Detect challenging text patterns that need API
        ...
        # Words that often indicate challenging text for basic reconstruction
        ...
        if (corruption_level is not None and corruption_level > 0.4) or has_challenging_pattern:
            ...
            if budget_remaining > 0.3:
                ...
                # Increase chance to 60% to ensure we use advanced methods for challenging texts
                ...
                # Increase chance to 40% for challenging texts
    ...
    if use_kb:
        try:
            ...
            if kb_result != noisy_text:
                # IMPORTANT NEW CODE: Verify changes don't break correct words
